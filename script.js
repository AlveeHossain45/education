...
const navConfig = {
    ...
    Teacher: [
        // Dashboard & Overview
        { icon: 'fa-tachometer-alt', text: 'Dashboard', page: 'dashboard', badge: 'Live' },
        
        // Student Management
        { icon: 'fa-user-graduate', text: 'My Students', page: 'students', submenu: [
            { icon: 'fa-list-ol', text: 'Class List', page: 'students/list' },
            { icon: 'fa-chart-bar', text: 'Performance Analysis', page: 'students/performance' },
            { icon: 'fa-comments', text: 'Student Feedback', page: 'students/feedback' }
        ]},
        
        // Classroom Operations
        { icon: 'fa-calendar-check', text: 'Attendance', page: 'attendance', submenu: [
            { icon: 'fa-calendar-day', text: 'Daily Attendance', page: 'attendance/daily' },
            { icon: 'fa-chart-pie', text: 'Attendance Reports', page: 'attendance/reports' },
            { icon: 'fa-bell', text: 'Absence Alerts', page: 'attendance/alerts' }
        ]},
        
        { icon: 'fa-calendar-alt', text: 'Schedule', page: 'timetable', submenu: [
            { icon: 'fa-clock', text: 'My Timetable', page: 'timetable/view' },
            { icon: 'fa-exchange-alt', text: 'Substitution', page: 'timetable/substitution' },
            { icon: 'fa-plus-circle', text: 'Extra Classes', page: 'timetable/extra' }
        ]},
        
        // Academic Management
        { icon: 'fa-book-open', text: 'Lesson Plans', page: 'lessons', badge: 'New' }, // New Feature
        { icon: 'fa-tasks', text: 'Assignments', page: 'assignments', submenu: [
            { icon: 'fa-plus', text: 'Create Assignment', page: 'assignments/create' },
            { icon: 'fa-inbox', text: 'Submitted Work', page: 'assignments/submissions' },
            { icon: 'fa-check-circle', text: 'Grading', page: 'assignments/grading' }
        ]},
        
        { icon: 'fa-file-alt', text: 'Exams', page: 'exams', submenu: [
            { icon: 'fa-edit', text: 'Create Tests', page: 'exams/create' },
            { icon: 'fa-check-double', text: 'Grade Exams', page: 'exams/grading' },
            { icon: 'fa-chart-line', text: 'Result Analysis', page: 'exams/analysis' }
        ]},
        
        // Communication
        { icon: 'fa-bullhorn', text: 'Announcements', page: 'notices', submenu: [
            { icon: 'fa-plus', text: 'Post Notice', page: 'notices/create' },
            { icon: 'fa-list', text: 'All Notices', page: 'notices/all' }
        ]},
        
        { icon: 'fa-comments', text: 'Communications', page: 'messages', submenu: [
            { icon: 'fa-envelope', text: 'Contact Students', page: 'messages/students' },
            { icon: 'fa-users', text: 'Contact Parents', page: 'messages/parents' },
            { icon: 'fa-user-tie', text: 'Staff Messages', page: 'messages/staff' }
        ]},
        
        // Resources
        { icon: 'fa-book-reader', text: 'Teaching Resources', page: 'resources', submenu: [
            { icon: 'fa-file-pdf', text: 'Materials', page: 'resources/materials' },
            { icon: 'fa-video', text: 'Multimedia', page: 'resources/media' },
            { icon: 'fa-link', text: 'Useful Links', page: 'resources/links' }
        ]},
        
        // Professional
        { icon: 'fa-chalkboard-teacher', text: 'Professional Development', page: 'pd', submenu: [
            { icon: 'fa-graduation-cap', text: 'Training', page: 'pd/training' },
            { icon: 'fa-certificate', text: 'Certifications', page: 'pd/certifications' }
        ]},
        
        // Personal
        { icon: 'fa-user-circle', text: 'Profile', page: 'profile', submenu: [
            { icon: 'fa-cog', text: 'Settings', page: 'profile/settings' },
            { icon: 'fa-shield-alt', text: 'Privacy', page: 'profile/privacy' }
        ]},
        
        // System
        { icon: 'fa-question-circle', text: 'Help Center', page: 'help' },
        { icon: 'fa-sign-out-alt', text: 'Logout', page: 'logout', divider: true }
    ],
     // --- START: ENHANCED STUDENT NAVIGATION ---  
Student: [  
    // Dashboard & Overview  
    { icon: 'fa-tachometer-alt', text: 'Dashboard', page: 'dashboard', badge: 'New' },  

    // Academics  
    { icon: 'fa-book-open', text: 'Study Materials', page: 'materials', submenu: [  
        { icon: 'fa-file-pdf', text: 'Lecture Notes', page: 'materials/notes' },  
        { icon: 'fa-video', text: 'Recorded Lectures', page: 'materials/videos' },  
        { icon: 'fa-link', text: 'Useful Links', page: 'materials/links' }  
    ]},  
    { icon: 'fa-file-alt', text: 'My Results', page: 'exams', submenu: [  
        { icon: 'fa-chart-bar', text: 'Progress Report', page: 'exams/progress' },  
        { icon: 'fa-award', text: 'Achievements', page: 'exams/achievements' }  
    ]},  
    { icon: 'fa-calendar-alt', text: 'My Timetable', page: 'timetable', badge: 'Updated' },  

    // Social & Communication  
    { icon: 'fa-user-graduate', text: 'My Classmates', page: 'students' },  
    { icon: 'fa-users', text: 'Study Groups', page: 'groups' }, // New  
    { icon: 'fa-bullhorn', text: 'Notice Board', page: 'notices' },  
    { icon: 'fa-envelope', text: 'Messages', page: 'messages', submenu: [  
        { icon: 'fa-comment-alt', text: 'Chat with Teachers', page: 'messages/teachers' },  
        { icon: 'fa-user-friends', text: 'Peer Discussion', page: 'messages/peers' }  
    ]},  

    // Resources & Activities  
    { icon: 'fa-book-reader', text: 'Library', page: 'library', submenu: [  
        { icon: 'fa-search', text: 'Search Books', page: 'library/search' },  
        { icon: 'fa-bookmark', text: 'My Borrowed Books', page: 'library/borrowed' },  
        { icon: 'fa-clock', text: 'Reservations', page: 'library/reservations' }  
    ]},  
    { icon: 'fa-laptop-code', text: 'Online Labs', page: 'labs' }, // New  
    { icon: 'fa-calendar-check', text: 'Events', page: 'events' }, // New  

    // Finance & Profile  
    { icon: 'fa-file-invoice-dollar', text: 'My Fees', page: 'fees', submenu: [  
        { icon: 'fa-receipt', text: 'Payment History', page: 'fees/history' },  
        { icon: 'fa-credit-card', text: 'Payment Methods', page: 'fees/payment' }  
    ]},  
    { icon: 'fa-user-circle', text: 'My Profile', page: 'profile', submenu: [  
        { icon: 'fa-cog', text: 'Settings', page: 'profile/settings' },  
        { icon: 'fa-shield-alt', text: 'Privacy', page: 'profile/privacy' }  
    ]},  

    // Support & Logout  
    { icon: 'fa-question-circle', text: 'Help & Support', page: 'help' },  
    { icon: 'fa-sign-out-alt', text: 'Logout', page: 'logout', divider: true }  
],  
// --- START: ENHANCED ACCOUNTANT NAVIGATION ---
Accountant: [
    // Financial Dashboard
    { icon: 'fa-chart-pie', text: 'Dashboard', page: 'accountantDashboard', badge: 'Live Updates' },
    
    // Core Financial Operations
    { icon: 'fa-file-invoice-dollar', text: 'Fee Management', page: 'fees', submenu: [
        { icon: 'fa-plus-circle', text: 'Create Invoice', page: 'fees/create' },
        { icon: 'fa-search-dollar', text: 'Fee Collection', page: 'fees/collection' },
        { icon: 'fa-history', text: 'Payment History', page: 'fees/history' },
        { icon: 'fa-exclamation-triangle', text: 'Pending Payments', page: 'fees/pending' }
    ]},
    
    { icon: 'fa-money-check-alt', text: 'Payroll', page: 'salaries', submenu: [
        { icon: 'fa-user-tie', text: 'Staff Salaries', page: 'salaries/staff' },
        { icon: 'fa-chalkboard-teacher', text: 'Faculty Payments', page: 'salaries/faculty' },
        { icon: 'fa-file-alt', text: 'Payslips', page: 'salaries/payslips' }
    ]},
    
    // Financial Tracking
    { icon: 'fa-receipt', text: 'Expenses', page: 'expenses', submenu: [
        { icon: 'fa-plus', text: 'Add Expense', page: 'expenses/add' },
        { icon: 'fa-tags', text: 'Categories', page: 'expenses/categories' },
        { icon: 'fa-chart-bar', text: 'Expense Analysis', page: 'expenses/analysis' }
    ]},
    
    { icon: 'fa-piggy-bank', text: 'Budgeting', page: 'budget', badge: 'New' }, // New Feature
    
    // Reports & Analytics
    { icon: 'fa-file-export', text: 'Reports', page: 'financialReports', submenu: [
        { icon: 'fa-file-excel', text: 'Daily Reports', page: 'reports/daily' },
        { icon: 'fa-file-csv', text: 'Monthly Statements', page: 'reports/monthly' },
        { icon: 'fa-chart-line', text: 'Financial Analytics', page: 'reports/analytics' },
        { icon: 'fa-balance-scale', text: 'Balance Sheets', page: 'reports/balance' }
    ]},
    
    // Tax & Compliance
    { icon: 'fa-file-invoice', text: 'Tax Management', page: 'tax', submenu: [ // New Feature
        { icon: 'fa-calculator', text: 'Tax Calculator', page: 'tax/calculator' },
        { icon: 'fa-clock', text: 'Deadlines', page: 'tax/deadlines' },
        { icon: 'fa-upload', text: 'E-Filing', page: 'tax/filing' }
    ]},
    
    // System & Profile
    { icon: 'fa-cog', text: 'Settings', page: 'settings', submenu: [
        { icon: 'fa-coins', text: 'Currency Setup', page: 'settings/currency' },
        { icon: 'fa-percentage', text: 'Tax Rates', page: 'settings/tax' },
        { icon: 'fa-database', text: 'Data Backup', page: 'settings/backup' }
    ]},
...
// --- END: ENHANCED ACCOUNTANT NAVIGATION ---
Librarian: [
    // Core Operations
    { icon: 'fa-chart-line', text: 'Dashboard', page: 'library', badge: 'new' },
    { icon: 'fa-book', text: 'Book Catalog', page: 'catalog', submenu: [
        { icon: 'fa-search', text: 'Search Books', page: 'catalog/search' },
        { icon: 'fa-plus-circle', text: 'Add New Book', page: 'catalog/add' },
        { icon: 'fa-tags', text: 'Manage Categories', page: 'catalog/categories' }
    ]},
    { icon: 'fa-exchange-alt', text: 'Transactions', page: 'transactions', submenu: [
        { icon: 'fa-arrow-right', text: 'Check Out', page: 'transactions/checkout' },
        { icon: 'fa-arrow-left', text: 'Check In', page: 'transactions/checkin' },
        { icon: 'fa-history', text: 'Transaction History', page: 'transactions/history' }
    ]},
    { icon: 'fa-clock', text: 'Reservations', page: 'reservations', badge: 'hot' },
    
    // User Management
    { icon: 'fa-users', text: 'Members', page: 'members', submenu: [
        { icon: 'fa-user-plus', text: 'Add Member', page: 'members/add' },
        { icon: 'fa-id-card', text: 'Member Cards', page: 'members/cards' },
        { icon: 'fa-bell', text: 'Overdue Notices', page: 'members/notices' }
    ]},
    
    // System Tools
    { icon: 'fa-file-export', text: 'Reports', page: 'reports', submenu: [
        { icon: 'fa-calendar', text: 'Daily Summary', page: 'reports/daily' },
        { icon: 'fa-chart-pie', text: 'Analytics', page: 'reports/analytics' },
        { icon: 'fa-file-csv', text: 'Export Data', page: 'reports/export' }
    ]},
    { icon: 'fa-cog', text: 'System Settings', page: 'settings', submenu: [
        { icon: 'fa-bell', text: 'Notifications', page: 'settings/notifications' },
        { icon: 'fa-sliders-h', text: 'Preferences', page: 'settings/preferences' },
        { icon: 'fa-database', text: 'Backup/Restore', page: 'settings/backup' }
    ]},
...
// --- END: ENHANCED LIBRARIAN NAVIGATION ---
};
